...
### This tool de-bricks EX5601 / T56 routers using the MTK BootROM protocol.
**Traditional recovery often requires a UART terminal, TFTP server, manual U-Boot commands, and careful partition handling. This tool automates that process**
